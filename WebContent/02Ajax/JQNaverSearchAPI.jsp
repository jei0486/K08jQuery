...
<head>
<meta charset="UTF-8">
<title>JQNaverSearchAPI.jsp</title>
...
$('#searchFrm').click(function(){
    		$.ajax({
    			url : "../NaverSearchAPI.do?keyword=" + $('#keyword').val(),
				success : function(rData) {
					$.each(rData.items, function(index, value) {
						var htmlStr = "<ul>";
						htmlStr += "<li>"+(index+1) +"</li>";
						htmlStr += "<li>"+value.title +"</li>";
						htmlStr += "<li>"+value.link +"</li>";
						htmlStr += "<li>"+value.content +"</li>";
						htmlStr += "</ul>";
