...
<script src="../common/jquery/jquery-3.5.1.js"></script>
    ...
    $.ajaxSetup()
    	...
    	url,type, data, dataType 등의 속성은 기본적으로 사용되므로 묶어주면 편하다.
    ...
    */
           ...
           $('#btn').click(function(){
        		$.ajax({
					success : function(rData) {
						/*  
						콜백되는 JSON 배열 데이터를 each() 로 읽어서 배열의 갯수만큼
						반복한다. 이때 각 반복시 JSON 객체를 파싱하게 된다.
						파싱할때는 .(점) 과 [](배열) 두가지 형태를 사용 할수 있다.
						*/
    ...
    /*  실패시 호출되는 콜백 메소드도 콜백 데이터를 갖고 있으며 아래와 같이 사용한다.
    
   :) json 파일에  </html>  추가시 실패:200:parsererror 가 뜸
 //url 에서 존재하지않는 url로 수정해서 실행하면 404가 뜸
    */
